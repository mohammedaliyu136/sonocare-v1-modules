...
import 'package:sonocare_partner2/view/screens/pharmacy/dashboard/dashboard.dart';
...
class RouteHelper {
  ...
  static const String goingToPharmacyRequestFinished = '/pharmacy/request/finished';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: labDashboard, page: () => getRoute(const LabDashboardScreen())),
    ...
    GetPage(name: ambulanceDashboard, page: () => getRoute(const AmbulanceDashboardScreen())),
