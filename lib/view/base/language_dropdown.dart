        ...
        Expanded(
          child: CheckboxListTile(
            ...
            title: Text(text, style: TextStyle(color: Colors.white),),
              checkColor: ColorResources.COLOR_PURPLE_DEEP,
...
///
///
class LanguageDropDownMultiSelect extends StatefulWidget {
  ...
  const LanguageDropDownMultiSelect({
    Key? key,
...
class _DropDownMultiSelectState extends State<LanguageDropDownMultiSelect> {
  @override
  Widget build(BuildContext context) {
    return Container(
      //height: 100,
      ...
      child: Stack(
        children: [
          _theState.rebuilder(() => widget.childBuilder != null
              ...
              child: Padding(
                  padding:
                  //EdgeInsets.symmetric(vertical: 23,//15,
                  //                   horizontal: 0,//10
                  //),
