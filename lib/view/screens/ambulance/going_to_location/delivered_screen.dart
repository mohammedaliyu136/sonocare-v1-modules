...
class AmbulanceArrivedSuccessfully extends StatefulWidget {
  const AmbulanceArrivedSuccessfully({Key? key}) : super(key: key);

  @override
  State<AmbulanceArrivedSuccessfully> createState() => _DeliveredScreenState();
}

class _DeliveredScreenState extends State<AmbulanceArrivedSuccessfully> {
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()=>Get.offAllNamed('/ambulance/dashboard'),
                  child: Container(
                    height: 55,
                    decoration: const BoxDecoration(
