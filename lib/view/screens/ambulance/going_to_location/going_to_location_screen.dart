...
class GoingToLocationAmbulanceScreen extends StatefulWidget {
  const GoingToLocationAmbulanceScreen({Key? key}) : super(key: key);

  @override
  State<GoingToLocationAmbulanceScreen> createState() => _GoingToLocationScreenState();
}

class _GoingToLocationScreenState extends State<GoingToLocationAmbulanceScreen> {
  DeliveryRequestsModel? deliveryRequestsModel;
  double lat = 8.992804;
  double lng = 7.432491;
  //9.21406397684134, 12.488736896453696
  double lat_des = 9.087469;
  double lng_des = 7.494752;
  @override
  void initState() {
        ...
        Scaffold(
          ...
          body: Stack(
            children: [
              ...
              Column(
                children: [
                  Expanded(child: MapPage(source_location: const LatLng(8.992804, 7.432491), destination_location: const LatLng(9.087469, 7.494752), icon: 'ambulance',)),
                              ...
                              children: [
                                Expanded(
                                  child: GestureDetector(
                                    onTap: ()=>Get.offAllNamed('/ambulance/request/completed'),
                                    child: Container(
                                      height: 55,
                                      decoration: const BoxDecoration(
                                          color: ColorResources.COLOR_PURPLE_DEEP,
