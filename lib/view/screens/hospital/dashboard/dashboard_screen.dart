...
import 'package:sonocare_partner2/view/screens/hospital/service_pref/service_pref_screen.dart';
...
class HospitalDashboardScreen extends StatefulWidget {
  ...
  _HospitalDashboardScreenState createState() {
    return _HospitalDashboardScreenState();
  }
}
              ...
              appBar: AppBar(
                title: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 4,),
                    Text('Hospital Name', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600),)
                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      DrawerHeader(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 10,),
                            const Text('Hospital Name',  style: TextStyle(fontSize: 20, color: ColorResources.COLOR_WHITE),)
                      ...
                      ListTile(
                        contentPadding: const EdgeInsets.only(left: 60, top: 0, bottom: 0),
                        title: const Text('REQUESTS'),//Profile
                        onTap: () {
                          Get.toNamed('/hospital/request/list');
                        },
                      ),
                      const Divider(),
                      ListTile(
                        contentPadding: const EdgeInsets.only(left: 60, top: 0, bottom: 0),
                        title: const Text('SERVICES'),//Profile
                        onTap: () {
                          Get.toNamed('/hospital/service/list');
                        },
                      ),
                      const Divider(),
                      ListTile(
                ...
                child: ListView(children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ServicePreferenceScreen()),
                      );
                    },
                  ),
                  const SizedBox(height: 20,),
                  GestureDetector(
                    child: LGConatiner(heading: 'Hospital Requests', body: 'You have no bookings at the moment', imageUrl: 'assets/icons/appointment_icon.png'),
                    onTap: (){
                      print('get Hospital Requests');
                      /*
                  ...
                  const SizedBox(height: 20,),
                  GestureDetector(
                    child: LGConatiner(heading: 'Hospital Services List', body: 'You have no Services at the moment'),
                    onTap: (){
                      print('get Hospital Service list');
                      /*
                      String token = Provider.of<AuthProvider>(context, listen: false).token;
                      Provider.of<AppointmentProvider>(context, listen: false).getAppointments(context, token, '0');
                       */
