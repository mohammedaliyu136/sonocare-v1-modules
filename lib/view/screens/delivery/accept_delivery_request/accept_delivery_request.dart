...
class AcceptDeliveryRequestScreen extends StatefulWidget {
  const AcceptDeliveryRequestScreen({Key? key}) : super(key: key);

  @override
  State<AcceptDeliveryRequestScreen> createState() => _AcceptDeliveryRequestScreenState();
}

class _AcceptDeliveryRequestScreenState extends State<AcceptDeliveryRequestScreen> {
            ...
            children: [
                          ...
                          SafeArea(
                            child: Column(
                              children: [
                                ...
                                //Todo: add loading...
                                Text(deliveryRequestsModel!.name, style: const TextStyle(
                                    fontSize: 20,
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Text(deliveryRequestsModel!.detail, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.white, letterSpacing: 1.1),))
                ],),
              ),
              Padding(
                padding: const EdgeInsets.only(top:30.0, bottom: 8, left: 15, right: 15),
              ...
              Padding(
                ...
                child: Row(children: [
                  //  26th May 2021 (09:00 AM - 10 PM)
                  Expanded(child: Text(deliveryRequestsModel!.location, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.white, letterSpacing: 1.1),))
                ],),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: normalButton(
                      ...
                      backgroundColor: ColorResources.COLOR_PURPLE_DEEP,
                      onTap: () {
                        Get.toNamed('/delivery/request/going');
                      },
                    )),
                  ],
                ),
