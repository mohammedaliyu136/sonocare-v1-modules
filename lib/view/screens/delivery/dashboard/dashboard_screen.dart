...
class DeliveryDashboardScreen extends StatefulWidget {
  ...
  _DeliveryDashboardScreenState createState() {
    return _DeliveryDashboardScreenState();
  }
}
            ...
            return Scaffold(
              ...
              body: index==0?Padding(
                ...
                child: ListView(children: [
                  ...
                  GestureDetector(
                    child: LGConatiner(heading: 'Delivery Requests', body: 'You have no bookings at the moment', imageUrl: 'assets/icons/appointment_icon.png'),
                    onTap: (){
                      print('get Delivery Requests');
                      /*
                      String token = Provider.of<AuthProvider>(context, listen: false).token;
                      Provider.of<AppointmentProvider>(context, listen: false).getAppointments(context, token, '0');
                       */
                      Get.toNamed('/delivery/request/list');
