...
import 'package:sonocare_partner2/view/screens/delivery/request/widgets/search_text_field.dart';
                          ...
                          itemBuilder: (context, index) {
                            if(deliveryController.deliveryRequests.length-1==index){
                              return Column(children: [
                                GestureDetector(
                                  onTap: (){Get.toNamed('/delivery/request/accept', arguments: deliveryController.deliveryRequests[index]);},
                                  child: Padding(
