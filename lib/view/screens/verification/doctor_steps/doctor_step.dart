...
import 'package:sonocare_partner2/view/screens/verification/doctor_steps/step01.dart';
import 'package:sonocare_partner2/view/screens/verification/doctor_steps/step02.dart';
import 'package:sonocare_partner2/view/screens/verification/doctor_steps/step03.dart';
import 'package:sonocare_partner2/view/screens/verification/doctor_steps/step04.dart';
                  ...
                  child: normalButton(
                    ...
                    onTap: ()async{
                      ...
                      if(step!=4){
                        ...
                        print('finished');
                        VerificationModel verificationModel = verificationFormController.doctorStep4Verified(context);
                        if(verificationModel.verified){
                          String token = Get.find<AuthController>().token;
                          verificationController.setToken(token);
                          print('token: ${token}');
                          print(verificationFormController.doctorGetStep1(''));
                          print(verificationFormController.doctorGetStep2());
                          print(verificationFormController.doctorGetStep3());
                          print(verificationFormController.doctorGetStep4());

                          /*
                          await verificationController.startUpload(
                            //step1: verificationFormController.getStep1(Get.find<AuthController>().doctorTypeList[0].title),
                            step1: verificationFormController.doctorGetStep1(''),
                            step2: verificationFormController.doctorGetStep2(),
                            step3: verificationFormController.doctorGetStep3(),
                            step4: verificationFormController.doctorGetStep4(),
