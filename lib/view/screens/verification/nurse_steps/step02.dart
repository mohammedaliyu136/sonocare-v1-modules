  ...
  Widget build(BuildContext context) {
    return GetBuilder<VerificationFormController>(builder: (verificationFormController) {
        return Column(children: [
          ...
          const SizedBox(height: 15,),
          textField(label: 'Account Number', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter referred By', controller: verificationFormController.accountNumberController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
          textField(label: 'Account Name', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter referred By', controller: verificationFormController.accountNameController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
          textField(label: 'Bank Code', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter referred By', controller: verificationFormController.bankCodeController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
