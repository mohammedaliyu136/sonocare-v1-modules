...
import 'package:sonocare_partner2/view/screens/verification/nurse_steps/step01.dart';
import 'package:sonocare_partner2/view/screens/verification/nurse_steps/step02.dart';
import 'package:sonocare_partner2/view/screens/verification/nurse_steps/step03.dart';
import 'package:sonocare_partner2/view/screens/verification/nurse_steps/step04.dart';
import 'package:sonocare_partner2/view/screens/verification/line.dart';

class NurseVerificationScreen extends StatefulWidget {
  const NurseVerificationScreen({Key? key}) : super(key: key);

  @override
  State<NurseVerificationScreen> createState() => _NurseVerificationScreenState();
}
    ...
    return Stack(children: [
      ...
      Scaffold(
        ...
        appBar: AppBar(title: const Padding(
          ...
          child: Text('Nurse Verification', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w400),),
        ),
          backgroundColor: Colors.transparent,
          elevation: 0,
        ),
                ...
                Padding(
                  ...
                  child: normalButton(
                    ...
                    onTap: ()async{
                      if(step!=4){
                        if(step==1){
                          VerificationModel verificationModel = verificationFormController.nurseStep1Verified(context);
                          ...
                          VerificationModel verificationModel = verificationFormController.nurseStep2Verified(context);
                          if(verificationModel.verified){
                            setState(() {
                              step+=1;
                            });
                          ...
                          VerificationModel verificationModel = verificationFormController.nurseStep3Verified(context);
                          if(verificationModel.verified){
                            setState(() {
                              step+=1;
                            });
                        ...
                        print('finished');
                        VerificationModel verificationModel = verificationFormController.nurseStep4Verified(context);
                        if(verificationModel.verified){
                          String token = Get.find<AuthController>().token;
                          verificationController.setToken(token);
                          print('token: ${token}');
                          print(verificationFormController.nurseGetStep1(''));
                          print(verificationFormController.nurseGetStep2());
                          print(verificationFormController.nurseGetStep3());
                          print(verificationFormController.nurseGetStep4());

                          /*
                          await verificationController.startUpload(
                            //step1: verificationFormController.getStep1(Get.find<AuthController>().NurseTypeList[0].title),
                            step1: verificationFormController.nurseGetStep1(''),
                            step2: verificationFormController.nurseGetStep2(),
                            step3: verificationFormController.nurseGetStep3(),
                            step4: verificationFormController.nurseGetStep4(),
