  ...
  Widget build(BuildContext context) {
    return GetBuilder<VerificationFormController>(builder: (verificationFormController) {
        return Column(children: [
          ...
          const SizedBox(height: 15,),
          textField(label: 'Account Number', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter account number', controller: verificationFormController.accountNumberController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
          textField(label: 'Account Name', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter account name', controller: verificationFormController.accountNameController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
          textField(label: 'Account bank name', icon: const Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter bank name', controller: verificationFormController.bankNameController, validator: (){}, onChanged: (){}),
          const SizedBox(height: 15,),
        ],);
      }
    );
