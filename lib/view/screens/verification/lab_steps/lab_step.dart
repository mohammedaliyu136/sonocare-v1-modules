...
import 'package:sonocare_partner2/view/screens/verification/lab_steps/step01.dart';
import 'package:sonocare_partner2/view/screens/verification/lab_steps/step02.dart';
import 'package:sonocare_partner2/view/screens/verification/lab_steps/step03.dart';
import 'package:sonocare_partner2/view/screens/verification/lab_steps/step04.dart';
import 'package:sonocare_partner2/view/screens/verification/line.dart';

class LabVerificationScreen extends StatefulWidget {
  const LabVerificationScreen({Key? key}) : super(key: key);

  @override
  State<LabVerificationScreen> createState() => _LabVerificationScreenState();
}
                    ...
                    onTap: ()async{
                      if(step!=4){
                        ...
                        if(verificationModel.verified){
                          ...
                          print('token: ${token}');
                          /*
                          print(verificationFormController.getStep1(''));
                          print(verificationFormController.getStep2());
                          print(verificationFormController.getStep3());
                          print(verificationFormController.getStep4());

                          await verificationController.startUpload(
                            //step1: verificationFormController.getStep1(Get.find<AuthController>().LabTypeList[0].title),
