...
class AcceptPickUpRequestScreen extends StatefulWidget {
  const AcceptPickUpRequestScreen({Key? key}) : super(key: key);

  @override
  State<AcceptPickUpRequestScreen> createState() => _AcceptPickUpRequestScreenState();
}

class _AcceptPickUpRequestScreenState extends State<AcceptPickUpRequestScreen> {
            ...
            children: [
                          ...
                          SafeArea(
                            child: Column(
                              children: [
                                ...
                                //Todo: add loading...
                                Text(pickUpRequestsModel!.name, style: const TextStyle(
                                    fontSize: 20,
                    ...
                    child: SafeArea(
                      child: Padding(
                        ...
                        child: Row(children: [
                          ...
                          const Text('Accept PickUp Requests', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w400),),
                        ],),
                      ),
                    ),
                  )
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Text(pickUpRequestsModel!.detail, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.white, letterSpacing: 1.1),))
                ],),
              ),
              Padding(
                padding: const EdgeInsets.only(top:30.0, bottom: 8, left: 15, right: 15),
              ...
              Padding(
                ...
                child: Row(children: [
                  //  26th May 2021 (09:00 AM - 10 PM)
                  Expanded(child: Text(pickUpRequestsModel!.location, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.white, letterSpacing: 1.1),))
                ],),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: normalButton(
                      ...
                      backgroundColor: ColorResources.COLOR_PURPLE_DEEP,
                      onTap: () {
                        Get.toNamed('/pickUp/request/going');
                      },
                    )),
                  ],
                ),
