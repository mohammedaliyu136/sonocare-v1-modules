...
class PickUpDashboardScreen extends StatefulWidget {
  const PickUpDashboardScreen({Key? key}) : super(key: key);

  @override
  _PickUpDashboardScreenState createState() {
    return _PickUpDashboardScreenState();
  }
}
            ...
            return Scaffold(
              ...
              body: index==0?Padding(
                ...
                child: ListView(children: [
                  ...
                  GestureDetector(
                    child: LGConatiner(heading: 'PickUp Requests', body: 'You have no bookings at the moment', imageUrl: 'assets/icons/appointment_icon.png'),
                    onTap: (){
                      print('get PickUp Requests');
                      /*
                      String token = Provider.of<AuthProvider>(context, listen: false).token;
                      Provider.of<AppointmentProvider>(context, listen: false).getAppointments(context, token, '0');
                       */
                      Get.toNamed('/pickup/request/list');
