...
import 'package:sonocare_partner2/view/screens/nurse/appointment/appointment_screen.dart';
import 'package:sonocare_partner2/view/screens/nurse/dashboard/settings_screen.dart';
...
class DashboardNurseScreen extends StatefulWidget {
  const DashboardNurseScreen({Key? key}) : super(key: key);
                ...
                child: ListView(children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                      ...
                      Get.toNamed('/nurse/service/preference');
                      /*
                      authController.getNurseService();
                      Navigator.push(
                        context,
