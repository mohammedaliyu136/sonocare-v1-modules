...
class MedicalReportScreen extends StatefulWidget {
  ...
  MedicalReportScreen({Key? key, required this.appointmentID}) : super(key: key);

  @override
  _MedicalReportScreenState createState() {
    return _MedicalReportScreenState();
  }
}
              ...
              return GetBuilder<PrescriptionController>(builder: (prescriptionController) {
                  return Padding(
                    ...
                    child: ListView(children: [
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 8.0),
                        child: Text('Report details', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w400),),
                      ),
                      TextField(
