              ...
              return GetBuilder<PrescriptionController>(builder: (prescriptionController) {
                  return Padding(
                    ...
                    child: ListView(children: [
                      ...
                      Row(children: [
                        Expanded(
                          child: Column(
                            ...
                            const Padding(
                              padding: EdgeInsets.symmetric(vertical: 8.0),
                              child: const Text('Age', style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w400),),
                            ),
                            TextField(
                              textInputAction: TextInputAction.next,
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 8.0),
                        child: const Text('Prescription', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w400),),
                      ),
                      TextField(
                    ...
                    const SizedBox(height: 30,),
                      ...
                      fontSize: 16, onTap: () {
                        ...
                        prescriptionController.setPrescription(
                            PrescriptionModel(
                                patientName: _patientNameController.text,
                                dateOfConsultation: _dateOfConsultationController.text,
                                prescription: _prescriptionController.text,
                                diagnosis: _diagnosisController.text,
                                age: _ageController.text.toString(),
                                gender: _genderController.text.isEmpty?'male':_genderController.text.toLowerCase(),
                                appointmentID: widget.appointmentID
                            ), url).then((ResponseModel responseModel){
