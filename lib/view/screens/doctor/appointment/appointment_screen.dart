...
import 'package:sonocare_partner2/view/screens/doctor/appointment/accept_appointment_screen.dart';
...
class _PendingAppointmentScreenState extends State<PendingAppointmentScreen> {
  ...
  @override
  void initState() {
    Get.find<AppointmentController>().getDoctorAppointments(url: '/api/getAlAppointments');
    super.initState();
  }
