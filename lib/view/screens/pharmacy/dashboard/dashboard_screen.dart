...
class PharmacyDashboardScreen extends StatefulWidget {
  ...
  @override
  _PharmacyDashboardScreenState createState() {
    return _PharmacyDashboardScreenState();
  }
}
            ...
            return Scaffold(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Get.toNamed('/pharmacy/request/list');
                        },
                      ),
                      const Divider(),
                      ListTile(
              ...
              body: index==0?Padding(
                ...
                child: ListView(children: [
                  ...
                  GestureDetector(
                    child: LGConatiner(heading: 'Pharmacy Requests', body: 'You have no bookings at the moment', imageUrl: 'assets/icons/appointment_icon.png'),
                    onTap: (){
                      print('get Pharmacy Requests');
                      /*
                  ...
                  const SizedBox(height: 20,),
                  GestureDetector(
                    child: LGConatiner(heading: 'Pharmacy Products List', body: 'You have no bookings at the moment'),
                    onTap: (){
                      print('get Pharmacy products list');
                      /*
                      String token = Provider.of<AuthProvider>(context, listen: false).token;
                      Provider.of<AppointmentProvider>(context, listen: false).getAppointments(context, token, '0');
                       */
