...
class PharmacyRequestCompletedScreen extends StatefulWidget {
  const PharmacyRequestCompletedScreen({Key? key}) : super(key: key);

  @override
  State<PharmacyRequestCompletedScreen> createState() => _PharmacyRequestCompletedScreenState();
}

class _PharmacyRequestCompletedScreenState extends State<PharmacyRequestCompletedScreen> {
  @override
  void initState() {
    super.initState();
  }
      ...
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            elevation: 0,
            title: const Text('Pharmacy Request'),
          ),
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()=>Get.offAllNamed('/pharmacy/dashboard'),
                  child: Container(
                    height: 55,
